        ...
        <div class="hotel-create-container">
            <form action="{{ route('adminHotelCreateProcess') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="hotel_name" id="hotel_name" value="{{ $hotel->hotel_name ?? old('hotel_name') }}" placeholder="Enter hotel name">
                    @error('hotel_name')
                ...
                <div class="form-group">
                    ...
                    <select name="prefecture_id" id="prefecture" >
                        ...
                        @foreach($prefectures as $prefecture)
                            <option value="{{ $prefecture->prefecture_id }}" {{ $hotel->prefecture_id == $prefecture->prefecture_id ? 'selected' : '' }}>
